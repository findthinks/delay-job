...
`passwd` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
...
`id` int unsigned NOT NULL AUTO_INCREMENT,
`uuid` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '调度器ID',
`last_heartbeat_time` bigint DEFAULT NULL COMMENT '最后心跳时间',
`register` varchar(5) COLLATE utf8mb4_general_ci NOT NULL COMMENT '注册信息',
`ip` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '调度器ip',
PRIMARY KEY (`id`),
...
`id` int NOT NULL,
`key` varchar(25) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'ID种子键',
`start_with` bigint DEFAULT '1' COMMENT '流水号起始',
`inc_span` int DEFAULT '1' COMMENT '增长步骤',
`description` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '说明',
PRIMARY KEY (`id`),
